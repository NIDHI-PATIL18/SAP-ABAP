...
*&
*&---------------------------------------------------------------------*
REPORT zprg_interactive_report_hide.
...
*store the table values in the hidden area by using the HIDE statement.

    HIDE : wa_vbak-vbeln , wa_vbak-erdat , wa_vbak-erzet , wa_vbak-ernam , wa_vbak-vbtyp ,
    wa_vbak-waerk , wa_vbak-vkorg.
  ENDLOOP.
